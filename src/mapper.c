...
int mapper_process_main(mr_t mr){
    ...
    size_t thread_creati=1; //controllo numero di thread creati, così se una thread_create fallisce, posso fare la join di quelli di quelli già esistenti
